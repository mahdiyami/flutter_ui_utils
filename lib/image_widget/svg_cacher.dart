...
// import 'package:admin/src/util/custom_cache_manager.dart';
...
/// )
/// ```
class SVGCacherProvider extends ImageProvider<SvgImageKey> {
  ...
  static Future<String> _getSvgString(SvgImageKey key) async {
    ...
    switch (key.source) {
      case SvgSource.network:
        try {
          var x = await key.cacheManager.getSingleFile(key.path);
          return await x.readAsString();
        } catch (e) {
          throw Exception(e);
        }
